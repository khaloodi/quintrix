...
By making these objects a separate classes we create what’s called a “separation of concerns.” The database object is concerned only with things in the database, while the data transfer objects are concerned only with things on the network.
 */
