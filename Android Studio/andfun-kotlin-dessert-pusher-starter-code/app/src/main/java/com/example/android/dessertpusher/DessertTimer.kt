 ...
 *
 */
class DessertTimer(lifecycle: Lifecycle) : LifecycleObserver { // giving timer ability to observe or watch for lifecycle
    // changes by adding " : LifecycleObserver"
    // give access to a lifecycle by adding "(lifecycle: Lifecycle)"
    ...
    // TODO (04) init constructor added as a part of adding the lifecycle
    init {
